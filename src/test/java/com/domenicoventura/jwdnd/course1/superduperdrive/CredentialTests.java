...
class CredentialTests extends SuperDuperDriveApplicationTests {
    ...
    public void testCredentialCreation() {
        ...
        createAndVerifyCredential("http://www.pippo.com", "pippo", "inzaghi", homePage);
    ...
    public void testCredentialModification() {
        ...
        String newUrl = "http://www.pluto.com";
        String newCredentialUsername = "pluto";
        String newPassword = "inzaghi";
    ...
    public void testDeletion() {
        HomePage homePage = signUpAndLogin();
        createCredential("http://www.pippo.com", "pippo", "inzaghi", homePage);
        createCredential("http://www.pluto.com", "pluto", "inzaghi", homePage);
        createCredential("http://www.paperino.com/", "paperino", "inzaghi", homePage);
